...
df <- read.csv('S1-SATTs for radar plot.csv', na.strings=c("",".","NA", "NaN", "#N/A", "#VALUE!"), stringsAsFactors = TRUE, header = F) 
...
write.csv(df_tidy, 'tidy_S1-SATTs for radar plot.csv')
